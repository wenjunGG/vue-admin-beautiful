...
/***/ "./src/views/byui/webUploader/static/upload.js":
/*!*****************************************************!*\
  !*** ./src/views/byui/webUploader/static/upload.js ***!
  \*****************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery) {__webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/_core-js@3.6.5@core-js/modules/es.symbol.js");

__webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/_core-js@3.6.5@core-js/modules/es.symbol.description.js");
    ...
    function addFile(file) {
      ...
      $btns.on("click", "span", function () {
        ...
        if (supportTransition) {
          ...
          $wrap.css("filter", "progid:DXImageTransform.Microsoft.BasicImage(rotation=" + ~~(file.rotation / 90 % 4 + 4) % 4 + ")"); // use jquery animate to rotation
          // $({
          //     rotation: rotation
          // }).animate({
